...
from torchvision.datasets import GTSRB  # 添加GTSRB数据集导入
...
if __name__ == "__main__":
    ...
    for label in range(num_labels[dataset]):
        ...
        detector = Detector(model=model, images=images, attack_type=args.attack_type, size_limit=args.size_limit, image_labels=image_labels, dataset=dataset)
