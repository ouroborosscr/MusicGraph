...
class pattern4Synthesizer(Synthesizer):
    ...
    # #abs
    # json_file_path = r"..\models\abs\MNIST_SIN\label_8\meta_1_label8.json"
    ...
    #         a = np.load(f"..\models\Aeva\MNIST_SIN\data_{i}_8.npy")
    ...
    # #B3D
    # a = torch.load("..\models\B3D\MNIST_SIN\\trigger_target_8\\trigger_target_8.pt")
    ...
    # #debackdoor
    # trigger_file = "..\models\debackdoor\\MNIST_SIN_patch_10000\\triggers\\trigger_label_8.pt"
    ...
    # #NC
    # arr2 = torch.load("../models/NC/MNIST_SIN/mask_8.pt")
