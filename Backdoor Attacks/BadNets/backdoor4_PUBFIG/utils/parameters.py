...
ALL_TASKS =  ['backdoor','backdoor2','backdoor3','backdoor4', 'normal', 'sentinet_evasion', #'spectral_evasion',
...
class Params:
    ...
    backdoor_label2: int = 1
    poisoning_proportion: float = 1.0  # backdoors proportion in backdoor loss
    synthesizer: str = 'pattern'
    synthesizer2: str = 'pattern2'
    synthesizer3: str = 'pattern3'
    synthesizer4: str = 'pattern4'
