...
class Helper:
    ...
    def __init__(self, params):
        ...
        self.make_synthesizer2()
        self.make_synthesizer3()
        self.make_synthesizer4()
        self.attack = Attack(self.params, self.synthesizer, self.synthesizer2, self.synthesizer3, self.synthesizer4)
    ...
    def make_synthesizer2(self):
        name_lower = self.params.synthesizer2.lower()
        name_cap = self.params.synthesizer2
        module_name = f'synthesizers.{name_lower}_synthesizer'
        try:
            synthesizer_module = importlib.import_module(module_name)
            task_class = getattr(synthesizer_module, f'{name_cap}Synthesizer')
            ...
            raise ModuleNotFoundError(
                f'The synthesizer: {self.params.synthesizer2}'
                f' should be defined as a class '
                f'{name_cap}Synthesizer in '
                f'synthesizers/{name_lower}_synthesizer.py')
        self.synthesizer2 = task_class(self.task)

    def make_synthesizer3(self):
        name_lower = self.params.synthesizer3.lower()
        name_cap = self.params.synthesizer3
        module_name = f'synthesizers.{name_lower}_synthesizer'
        try:
            synthesizer_module = importlib.import_module(module_name)
            task_class = getattr(synthesizer_module, f'{name_cap}Synthesizer')
            ...
            raise ModuleNotFoundError(
                f'The synthesizer: {self.params.synthesizer3}'
                f' should be defined as a class '
                f'{name_cap}Synthesizer in '
                f'synthesizers/{name_lower}_synthesizer.py')
        self.synthesizer3 = task_class(self.task)

    def make_synthesizer4(self):
        name_lower = self.params.synthesizer4.lower()
        name_cap = self.params.synthesizer4
        module_name = f'synthesizers.{name_lower}_synthesizer'
        try:
            synthesizer_module = importlib.import_module(module_name)
            task_class = getattr(synthesizer_module, f'{name_cap}Synthesizer')
            ...
            raise ModuleNotFoundError(
                f'The synthesizer: {self.params.synthesizer4}'
                f' should be defined as a class '
                f'{name_cap}Synthesizer in '
                f'synthesizers/{name_lower}_synthesizer.py')
        self.synthesizer4 = task_class(self.task)
