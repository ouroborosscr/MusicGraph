...
class pattern3Synthesizer(Synthesizer):
    ...
    # #abs
    # json_file_path = r"..\models\abs\MNIST_multi2\label_1\meta_1_label1.json"
    ...
    #         a = np.load(f"..\models\Aeva\MNIST_multi2\data_{i}_1.npy")
    ...
    # #B3D
    # a = torch.load("..\models\B3D\MNIST_multi2(2)\\trigger_target_1\\trigger_target_1.pt")
    ...
    # #debackdoor
    # trigger_file = "..\models\debackdoor\\MNIST_multi2_patch_10000\\triggers\\trigger_label_1.pt"
    ...
    #NC
    # arr2 = torch.load("../models/NC/MNIST_multi2/mask_1.pt")
